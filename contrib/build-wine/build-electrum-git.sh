...
for repo in electrum electrum-locale electrum-icons; do
	...
	URL=https://github.com/bitcoinquark/$repo.git
...
pushd $WINEPREFIX/drive_c/electrum-quark
...
cd dist
mv electrum-quark-setup.exe $NAME_ROOT-$VERSION-setup.exe
cd ..
